...
const TestimonialsSection = () => {
  ...
  const column2 = testimonials.slice(Math.ceil(testimonials.length / 3), Math.ceil(testimonials.length / 3) * 2);
  const column3 = testimonials.slice(Math.ceil(testimonials.length / 3) * 2);
