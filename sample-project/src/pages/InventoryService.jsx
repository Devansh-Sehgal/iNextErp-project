        ...
        <section className="py-24 bg-gradient-to-b from-white to-gray-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-gray-600">
                Choose the plan that best fits your business needs. All plans include our core inventory management features.
              </p>
            </motion.div>
              ...
              {[
                {
                  name: "Starter",
                  price: "$99",
                  description: "Perfect for small retailers with limited inventory",
                  features: [
                    "Up to 1,000 SKUs",
                    "2 user accounts",
                    "Basic analytics",
                ...
                <motion.div
                  ...
                  className={`rounded-xl overflow-hidden border ${
                    plan.highlighted 
                      ? 'border-primary shadow-lg relative scale-105' 
