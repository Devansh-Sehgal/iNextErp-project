        ...
        <section className="py-24 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-gray-600">
                Choose the plan that works best for your retail business. No hidden fees, no long-term contracts.
              </p>
            </motion.div>
              ...
              {[
                {
                  name: "Basic",
                  price: "$79",
                  description: "Essential POS features for small retailers",
                  features: [
                    "Single register",
                ...
                },
                {
                  name: "Standard",
                  price: "$149",
                  description: "Advanced features for growing retailers",
                  features: [
                    "Up to 3 registers",
                ...
                },
                {
                  name: "Premium",
                  price: "$249",
                  description: "Complete solution for established retailers",
                  features: [
                    "Unlimited registers",
                ...
                >
                  ...
                  <div className="p-6 md:p-8 bg-white">
                    ...
                    <Button 
                      className={`w-full ${!plan.highlighted ? 'bg-gray-800 hover:bg-gray-700' : ''}`}
